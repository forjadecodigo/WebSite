...
const SoftwareEmpresarial = () => {
  ...
  useEffect(() => {
    ...
    const targetId = (location.hash && location.hash.slice(1)) || 'software-empresarial-hero'
    let attempts = 0
  ...
  return (
    <div className="software-empresarial-container">
      ...
      <div className="software-empresarial-hero" id="software-empresarial-hero" style={{ scrollMarginTop: '76px', paddingTop: '76px' }}>
