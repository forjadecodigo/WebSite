  ...
  return (
    <>
      <style>{`
        ...
        .navigation-menu .active-element .strike svg { display: block; overflow: visible; height: 12px; width: calc(var(--active-element-width) * 2); transform: translate(var(--active-element-strike-x), 30%) scale(var(--active-element-scale-x), var(--active-element-scale-y)); }
      ...
      <nav className="navigation-menu" ref={navRef}>
        <div className="navigation-menu-inner">
          <a className="logo" href="#inicio-seccion1" onClick={(e) => { e.preventDefault(); if (onItemClick) onItemClick(0, items[0]); }}>
            <img src="/logo1.png" alt="Forja de Código" />
          </a>
          <ul>
